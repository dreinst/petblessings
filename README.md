...
- `superadmin.html`, dashboard superadmin: ringkasan angka (pemilik, hewan, pendamping, donasi, check-in per pos, reg ulang Pawrade), log login panitia dengan tombol setujui/tolak login admin.
...
- `pawrade-checkin.html`, reg ulang lomba Pawrade: scan QR di satu titik saja (lomba di satu lokasi/panggung), tanpa pilihan pos. Cara kerjanya sama dengan `checkin.html`.
